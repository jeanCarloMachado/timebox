...
var G__22464 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__22464;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__22465 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22465,ch);
...
if(("\\" === ch__$1)){
var ch_22466__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_22466__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_22466__$2);
} else {
}

var G__22467 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__22467;
continue;
}
}
...
var vec__22475 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22475,(0),null);
var start_column = cljs.core.nth.call(null,vec__22475,(1),null);
...
var G__22478 = cljs.core.conj_BANG_.call(null,a,form);
a = G__22478;
continue;
}
}
...
var _STAR_read_delim_STAR_22479 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_22479;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__22480 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22480,(0),null);
var start_column = cljs.core.nth.call(null,vec__22480,(1),null);
...
var vec__22483 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22483,(0),null);
var end_column = cljs.core.nth.call(null,vec__22483,(1),null);
...
var vec__22486 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22486,(0),null);
var start_column = cljs.core.nth.call(null,vec__22486,(1),null);
...
var vec__22489 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22489,(0),null);
var end_column = cljs.core.nth.call(null,vec__22489,(1),null);
...
var vec__22492 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22492,(0),null);
var start_column = cljs.core.nth.call(null,vec__22492,(1),null);
...
var vec__22495 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22495,(0),null);
var end_column = cljs.core.nth.call(null,vec__22495,(1),null);
...
var sb = (function (){var G__22498 = (new goog.string.StringBuffer());
G__22498.append(initch);
...
var G__22500 = (function (){var G__22499 = sb;
G__22499.append(ch);

return G__22499;
})();
var G__22501 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__22500;
ch = G__22501;
continue;
}
...
switch (G__22504) {
case "\\":
var G__22508 = (function (){var G__22505 = sb;
G__22505.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__22505;
})();
var G__22509 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22508;
ch = G__22509;
continue;
...
break;
default:
var G__22510 = (function (){var G__22506 = sb;
G__22506.append(ch);

return G__22506;
})();
var G__22511 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22510;
ch = G__22511;
continue;
...
var vec__22512 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22512,(0),null);
var end_column = cljs.core.nth.call(null,vec__22512,(1),null);
...
var vec__22515 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22515,(0),null);
var column = cljs.core.nth.call(null,vec__22515,(1),null);
...
var vec__22520 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22520,(0),null);
var column = cljs.core.nth.call(null,vec__22520,(1),null);
...
var vec__22525 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22525,(0),null);
var column = cljs.core.nth.call(null,vec__22525,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__22530 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22530,(0),null);
var start_column = cljs.core.nth.call(null,vec__22530,(1),null);
...
var vec__22533 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22533,(0),null);
var end_column = cljs.core.nth.call(null,vec__22533,(1),null);
...
var G__22536 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__22536,true,null,opts,pending_forms);
...
var G__22537 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__22537)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__22537)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__22537)){
...
var _STAR_suppress_read_STAR_22538 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_22538;
}});
...
var G__22539 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__22539,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__22539,rdr,first_line);
...
var G__22543 = matched;
var G__22544 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__22543;
finished = G__22544;
continue;
} else {
...
var _STAR_suppress_read_STAR_22545 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_22545;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env22546 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__22547 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22547,"(");
...
var G__22548 = (i + (1));
var G__22549 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env22546;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__22550 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__22550);
...
var G__22551 = cljs.core.next.call(null,s__$1);
var G__22552 = ret;
s__$1 = G__22551;
r = G__22552;
continue;
...
var G__22553 = cljs.core.next.call(null,s);
var G__22554 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__22553;
key_vals = G__22554;
continue;
} else {
...
var gensym_env22558 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env22558;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__22559 = token;
var G__22559__$1 = (((G__22559 == null))?null:cljs.core.subs.call(null,G__22559,(1)));
var G__22559__$2 = (((G__22559__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22559__$1));
var G__22559__$3 = (((G__22559__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22559__$2));
var G__22559__$4 = (((G__22559__$3 == null))?null:cljs.core.symbol.call(null,G__22559__$3));
if((G__22559__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__22559__$4);
}
})():(function (){var G__22560 = token;
var G__22560__$1 = (((G__22560 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22560));
if((G__22560__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22560__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__22571,reader){
var map__22572 = p__22571;
var map__22572__$1 = ((((!((map__22572 == null)))?(((((map__22572.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22572.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22572):map__22572);
var opts = map__22572__$1;
var eof = cljs.core.get.call(null,map__22572__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___22580 = arguments.length;
var i__4500__auto___22581 = (0);
while(true){
if((i__4500__auto___22581 < len__4499__auto___22580)){
args__4502__auto__.push((arguments[i__4500__auto___22581]));

var G__22582 = (i__4500__auto___22581 + (1));
i__4500__auto___22581 = G__22582;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq22578){
var G__22579 = cljs.core.first.call(null,seq22578);
var seq22578__$1 = cljs.core.next.call(null,seq22578);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22579,seq22578__$1);
});


//# sourceMappingURL=reader.js.map?rel=1556967717306
