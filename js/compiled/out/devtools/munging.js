...
var o23497 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23497["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23498 = temp__5455__auto____$1;
return (o23498["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22609__auto__ = f;
return (o__22609__auto__["toString"]).call(o__22609__auto__);
} else {
return "";
}
}catch (e23499){var _ = e23499;
return "";
}});
...
try{var o__22609__auto___23501 = t;
(o__22609__auto___23501["cljs$lang$ctorPrWriter"]).call(o__22609__auto___23501,t,writer);
}catch (e23500){var __23502 = e23500;
}
...
var char_code = (function (){var o__22609__auto__ = (new String(char$));
return (o__22609__auto__["charCodeAt"]).call(o__22609__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22609__auto__ = String;
return (o__22609__auto__["fromCharCode"]).call(o__22609__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23503 = num_code;
switch (G__23503) {
case (1):
return (185);
...
var o__22609__auto__ = String;
return (o__22609__auto__["fromCharCode"]).call(o__22609__auto__,superscript_code);
});
/**
...
}catch (e23505){var _e__22616__auto__ = e23505;
return false;
}})())){
...
var vec__23506 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23506,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23509 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23509["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23510 = temp__5455__auto____$1;
return (o23510["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23513){
var vec__23514 = p__23513;
var ns_detector = cljs.core.nth.call(null,vec__23514,(0),null);
...
var G__23520 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23521 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23520;
remaining_tokens = G__23521;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23511){
var G__23512 = cljs.core.first.call(null,seq23511);
var seq23511__$1 = cljs.core.next.call(null,seq23511);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23512,seq23511__$1);
});
...
var vec__23525 = cljs.core.split_with.call(null,(function (p1__23524_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23524_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23525,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23525,(1),null);
...
var vec__23528 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23528,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23528,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23531 = cljs.core.rest.call(null,remaining_tokens);
var G__23532 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23531;
name_tokens = G__23532;
continue;
} else {
...
var vec__23535 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23535,(0),null);
var arity = cljs.core.nth.call(null,vec__23535,(1),null);
var vec__23538 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23538,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23538,(1),null);
var vec__23541 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23541,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23541,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23541,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23541,(3),null);
...
var vec__23547 = result;
var munged_ns = cljs.core.nth.call(null,vec__23547,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23547,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23547,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23547,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23547,(4),null);
var arity = cljs.core.nth.call(null,vec__23547,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23551 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23551,(0),null);
var args = cljs.core.nth.call(null,vec__23551,(1),null);
var vec__23554 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23554,(0),null);
var name = cljs.core.nth.call(null,vec__23554,(1),null);
...
var G__23557 = (arity + (1));
var G__23558 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23559){
var vec__23560 = p__23559;
var arity = cljs.core.nth.call(null,vec__23560,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23560,(1),null);
...
return cljs.core.get.call(null,arities,p1__23563_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23564_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23567){
var vec__23568 = p__23567;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23568,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23565){
var G__23566 = cljs.core.first.call(null,seq23565);
var seq23565__$1 = cljs.core.next.call(null,seq23565);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23566,seq23565__$1);
});
...
var G__23574 = arg;
var G__23574__$1 = (((G__23574 instanceof cljs.core.Keyword))?G__23574.fqn:null);
switch (G__23574__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23576__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23576__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23576__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23576__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23577 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23577,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23577,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23577,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23577,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23577,(4),null);
var arity = cljs.core.nth.call(null,vec__23577,(5),null);
...
var o__22609__auto__ = f;
return (o__22609__auto__["getBasis"]).call(o__22609__auto__);
});
/**
...
}catch (e23581){var _e__22616__auto__ = e23581;
...
var G__23582 = (obj[cljs.core.first.call(null,path)]);
var G__23583 = cljs.core.rest.call(null,path);
obj = G__23582;
path = G__23583;
continue;
} else {
...
return (function (accum,p__23584){
var vec__23585 = p__23584;
var bit = cljs.core.nth.call(null,vec__23585,(0),null);
var protocol = cljs.core.nth.call(null,vec__23585,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23588){
var vec__23589 = p__23588;
var ns = cljs.core.nth.call(null,vec__23589,(0),null);
var name = cljs.core.nth.call(null,vec__23589,(1),null);
var selector = cljs.core.nth.call(null,vec__23589,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23594,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23594,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23594,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23592_SHARP_){
return (obj[cljs.core.first.call(null,p1__23592_SHARP_)]);
});})(name,sorted_matches,vec__23594,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1556967718034
