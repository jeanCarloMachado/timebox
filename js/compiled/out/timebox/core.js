...
timebox.core.notify_end = (function timebox$core$notify_end(){
timebox.core.show_desktop_notification.call(null,"Timebox is over","");

return (new Audio("bell.mp3")).play();
});
timebox.core.minutes_to_seconds = (function timebox$core$minutes_to_seconds(p1__27671_SHARP_){
return (p1__27671_SHARP_ * (60));
});
...
cljs.core.reset_BANG_.call(null,timebox.core.seconds_counter,(0));

setTimeout((function (){
return timebox.core.notify_end.call(null);
}),((1000) * timebox.core.minutes_to_seconds.call(null,cljs.core.deref.call(null,timebox.core.timebox_in_minutes))));

return (
timebox.core.timer_stop = (function timebox$core$timer_start_$_timer_stop(){
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"justify-content","justify-content",-1990475787),"center",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"center",new cljs.core.Keyword(null,"height","height",1025178622),"100%"], null)], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"background","background",-863952629),"#b9c1ce",new cljs.core.Keyword(null,"min-height","min-height",398480837),"400px",new cljs.core.Keyword(null,"min-width","min-width",1926193728),"400px",new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"justify-content","justify-content",-1990475787),"center",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"center",new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),"column"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Timebox size in minutes",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,timebox.core.timebox_in_minutes),new cljs.core.Keyword(null,"on-change","on-change",-732046149),timebox.core.change_timebox,new cljs.core.Keyword(null,"style","style",-496642736),timebox.core.style_input.call(null)], null)], null),((cljs.core.not.call(null,cljs.core.deref.call(null,timebox.core.timer_running)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),timebox.core.button_style.call(null),new cljs.core.Keyword(null,"type","type",1174270348),"button",new cljs.core.Keyword(null,"value","value",305978217),"Start",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return timebox.core.timer_start.call(null);
})], null)], null):null),((cljs.core._EQ_.call(null,true,cljs.core.deref.call(null,timebox.core.timer_running)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),timebox.core.button_style.call(null),new cljs.core.Keyword(null,"type","type",1174270348),"button",new cljs.core.Keyword(null,"value","value",305978217),"Stop",new cljs.core.Keyword(null,"on-click","on-click",1632826543),timebox.core.timer_stop], null)], null):null),((cljs.core._EQ_.call(null,true,cljs.core.deref.call(null,timebox.core.timer_running)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),["Percentage ellapsed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(timebox.core.percentage_ellapsed.call(null,cljs.core.deref.call(null,timebox.core.seconds_counter),cljs.core.deref.call(null,timebox.core.timebox_in_minutes)))," %"].join('')], null):null)], null)], null);
});
...
//# sourceMappingURL=core.js.map?rel=1557169495785
